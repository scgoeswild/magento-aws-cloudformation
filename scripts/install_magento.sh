...
yum -y update
yum -y install nginx php74-fpm php74-cli php74-mysqlnd php74-soap php74-xml php74-zip php74-json php74-mcrypt php74-intl php74-mbstring php74-zip php74-gd php74-bcmath mysql57
...
cat << EOF > /etc/php-fpm-7.4.conf
[global]
pid = /var/run/php-fpm/php-fpm-7.4.pid
error_log = /var/log/php-fpm/7.4/error.log
daemonize = yes
[www]
user = nginx
group = nginx
...
php_value[soap.wsdl_cache_dir]  = /var/lib/php/7.4/wsdlcache
EOF
...
* * * * * /usr/bin/php -c /etc/php-7.4.ini /var/www/html/bin/magento cron:run | grep -v "Ran jobs by schedule" >> /var/www/html/var/log/magento.cron.log
* * * * * /usr/bin/php -c /etc/php-7.4.ini /var/www/html/update/cron.php >> /var/www/html/var/log/update.cron.log
* * * * * /usr/bin/php -c /etc/php-7.4.ini /var/www/html/bin/magento setup:cron:run >> /var/www/html/var/log/setup.cron.log
EOF
